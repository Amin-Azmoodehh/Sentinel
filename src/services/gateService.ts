...
const aiRuleCheck: GateCheck = {
  ...
  run: async () => {
    ...
    try {
      ...
      const prompt = [
        '# SentinelTM Quality Gate - Code Review',
        '',
        'You are an expert code reviewer for the SentinelTM quality gate system.',
        '',
        '## YOUR TASK',
        'Analyze the provided code against the specified rules and provide a numerical quality score.',
        '',
        '## EVALUATION CRITERIA',
        ...
        'You MUST respond with ONLY the following single line:',
        '"Final Score: XX/100"',
        '',
        'Where XX is a number between 0 and 100:',
        '- 95-100: Exceptional, production-ready code',
        '- 85-94: Good quality, minor improvements possible',
        '- 70-84: Acceptable, requires some refinement',
        '- Below 70: Needs significant work',
        '',
        'IMPORTANT: Do NOT include any explanation, commentary, or additional text.',
        'Only output: "Final Score: XX/100"',
      ].join('\n');
